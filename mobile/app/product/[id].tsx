...
export default function DetailsProduct() {
  ...
  return (
    <View className="flex-1 bg-white">
              ...
              <View className="flex-row gap-3 mb-6 flex-wrap">
                {product.sizes.map((size) => (
                  <TouchableOpacity
                    ...
                    className={`
                  w-12 h-12 rounded-full items-center justify-center border ${selectedSize === size ? "bg-primary border-primary" : "bg-white border-gray-100"}`}
                  >
                    <Text
      ...
      <View className=" absolute bottom-0 left-0 flex-row right-0 p-4 bg-white border-t border-gray-100 mb-4">
        <TouchableOpacity
        ...
        <TouchableOpacity
          ...
          className="w-1/5 py-4 flex-row justify-center relative"
        >
